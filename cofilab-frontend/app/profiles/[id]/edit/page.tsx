...
export default function EditProfilePage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            Object.keys(formData).forEach(key => {
                // Exclure les champs de lecture seule et les listes d'objets (skills)
                if (typeof formData[key] !== 'object' || key === 'bio' || key === 'contact_phone') {
                    if (key !== 'skills' && key !== 'username' && key !== 'id' && key !== 'created_at' && key !== 'updated_at') {
    ...
    // Les compétences déjà sélectionnées pour le Select
                ...
                <main className="p-6 flex-1 overflow-auto">
                    <form onSubmit={handleSubmit} className="max-w-3xl mx-auto bg-white p-8 rounded-xl shadow-lg space-y-6">
                        <h1 className="text-2xl font-bold text-gray-900">
                            Éditer le Profil de **{formData.username}**
                        </h1>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            ...
                            <div className="md:col-span-2 space-y-2">
                                <label htmlFor="bio" className="block text-sm font-medium text-gray-700">Bio / Présentation</label>
                                <Textarea
                                    id="bio"
                                    name="bio"
                                    value={formData.bio || ''}
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <div className="space-y-2">
                                ...
                                <Input type="text" name="current_city" value={formData.current_city || ''} onChange={handleChange} placeholder="Paris, Berlin, etc." />
                            </div>
                        </div>
